...
$portableDirectory = Join-Path $releaseDirectory "Mermaids-Giants-Terra-v0.4.4-Windows"
$zipFile = Join-Path $releaseDirectory "Mermaids-Giants-Terra-v0.4.4-Windows.zip"
...
Set-Content -LiteralPath (Join-Path $portableDirectory "VERSION.txt") -Value "Mermaids-Giants-Terra 0.4.4`r`nBundled Node.js $nodeVersion" -Encoding UTF8
